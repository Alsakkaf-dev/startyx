/* ============================================================================
   ...
   البرنامج ثلاث صفحات مستقلّة، لكلٍّ هيكلها ودورها:
     ...
     index.html      الأنظمة التشغيلية التسعة — شريط أيقونات + شجرة النظام
   ...
   القاعدة: لكل محتوى صفحة واحدة تملكه.
     ...
     · حساب أو نظام مقترح (acc./prop.) ← reference.html، جدول مسطّح للقراءة
